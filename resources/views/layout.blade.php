        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                      <a href="/dashboard" class="menu-link" data-url="/dashboard">
                  ...
                  <!-- Supplier -->
                  <li class="menu-item">
                      <a href="javascript:void(0);" class="menu-link menu-toggle" data-url="/supplier">
                          <i class="menu-icon tf-icons bx bx-user"></i>
                          <div data-i18n="Supplier">Supplier</div>
                      </a>
                      <ul class="menu-sub">
                          <li class="menu-item">
                              <a href="/supplier" class="menu-link" data-url="/supplier">
                                  <div data-i18n="Supplier List">Supplier Information</div>
                              </a>
                          </li>
                          <li class="menu-item">
                              <a href="/order" class="menu-link" data-url="/order">
                                  <div data-i18n="Order Supplies">Order Supplies</div>
                              </a>
                          </li>
                          <li class="menu-item">
                              <a href="/delivery" class="menu-link" data-url="/delivery">
                                  <div data-i18n="Delivery Records">Delivery Records</div>
                              </a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <!-- Item Management -->
                  <li class="menu-item">
                      <a href="/item_management" class="menu-link" data-url="/item_management">
                  ...
                  <!-- Inventory -->
                  <li class="menu-item">
                    <a href="/inventory_management" class="menu-link" data-url="/inventory_management">
                        <i class="menu-icon tf-icons bx bx-package"></i>
                  ...
                  <!-- User Management -->
                  <li class="menu-item">
                      <a href="/user" class="menu-link" data-url="/user">
                  ...
                  <!-- Reports -->
                  <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle" data-url="/reports">
                      <i class="menu-icon tf-icons bx bx-package"></i>
                      <div data-i18n="Inventory">Reports</div>
                  </a>
                      <ul class="menu-sub">
                          <li class="menu-item">
                              <a href="/inventory_report" class="menu-link" data-url="/inventory_report">
                                  <div data-i18n="Inventory Report">Inventory Report</div>
                              </a>
                          </li>
                          <li class="menu-item">
                              <a href="/reorder_list_report" class="menu-link" data-url="/reorder_list_report">
                                  <div data-i18n="Reorder List Report">Reorder List Report</div>
                              </a>
                          </li>
                          <li class="menu-item">
                          ...
                          <li class="menu-item">
                              <a href="/sales_return_report" class="menu-link" data-url="/sales_return_report">
                                  <div data-i18n="Sales Return Report">Sales Return Report</div>
                              </a>
                          </li>
                          <li class="menu-item">
                              <a href="/transaction_history_report" class="menu-link" data-url="/transaction_history_report">
                                  <div data-i18n="Transaction History Report">Transaction History Report</div>
                              </a>
                          </li>
                      </ul>
                  </li>
